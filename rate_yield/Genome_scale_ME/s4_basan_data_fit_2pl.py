...
#create a pseudo proton leakage reaction
data = cobrame.StoichiometricData('Proton_leakage', me)
stoichiometry = {'h_c': -1,'h_p':1}
...
rxn = cobrame.MetabolicReaction('Proton_leakage')
me.add_reaction(rxn)
...
print(rxn.reaction)
pl_list=[25,50,75,100,125,150]
final_dict={}
for pl in pl_list:
    me.reactions.Proton_leakage.lower_bound=pl
    ...
    final_dict[pl]=target_dict

with open('s4_solution_pl.json', 'w') as fp:
